...
| 에디터 ID | `4856` _(라이브 — [에디터 4856](https://www.cdbd.in/editor/4856))_ |
| 카테고리 | ☑️ **초대·예약** |
| 활성화 | ON |
...
- ✅ **썸네일 모바일 캡처** — `recruit-rsvp-viewer-sharp.png` 상단 380×680 crop 부착 완료 (2026-06-19)
...
- ✅ **에디터 ID** — `4856` 라이브 (2026-06-19)
- 🖼️ **OG 이미지 (800×400 JPG)** — 디자인 완료 + JPG export (og.jpg). 에디터 4856 URL 정보 편집 모달에 **사용자 수동 업로드 필요** (자동화 불가, 1-4-1 매트릭스 명시)
