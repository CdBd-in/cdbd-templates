...
- [ ] **위치 카드 지도 모서리(🔴 원형/각진/둥근 **3종** · 2026-09-15 실측, 옛 2종 오류)·비율(가로/1:1)** 도 CdBd-legal 옵션으로 비교 — Figma 지도 프레임 종횡비·모서리를 CdBd 지도 옵션에 매핑(리터럴 px/임의 비율 ❌, 2026-07-07 5025 지도 비-legal 값 미스).
