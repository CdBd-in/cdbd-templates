...
정본 절차: `1. 작업 가이드/1-1. 워크플로우.md` 의 "🤖 무인 자동 제작 파이프라인" 섹션. 공통 원칙: `AGENTS.md`.
...
- 참조: `.Codex/skills/cdbd-daily-orchestrator/references/critic-checklists.md`, `.Codex/skills/cdbd-daily-orchestrator/references/report-template.md`
...
- `report-template.md`를 채워 `컨텍스트: 이선호/{오늘날짜} 자동제작 — {slug}.md` 작성. 링크 2개(Figma node, CdBd editor) 필수. 검수 로그(취향 판단 필요=⭐), AGENTS.md 후보 규칙, 경고(큐 잔량 ≤ `params.queue_low_threshold`, 적체, 누적 에디터) 포함.
