...
related: "[[3-2. 16 시나리오 질문 응답 테스트 세트]], [[1-9. AI 유저 플로우 (제품 설계도)]], [[4-5. 섹션 프리셋 라이브러리]], [[../CLAUDE.md]]"
---
...
**산출물**: 시안 16종 사양 문서(옛 3-3) — 질문 세트 검증을 마치고 **2026-07-16 폐기**. 확정 반영본은 [[4-2. AI 유저 플로우]] ③ 질문 3층. *(문서 전문은 git 이력에 보존)*
...
**산출물**: [[4-2. AI 유저 플로우]] ③ 질문 3층 · [[4-10. 16 시나리오 테스트]] 답변
...
프리셋 라이브러리가 아직 비어 있어, **여러 프리셋이 있다는 가정**으로 배리에이션 축을 시안에 심었다. 상세 표: [[4-5. 섹션 프리셋 라이브러리#🎨 디자인 속성 변주 — 검증된 수단 7가지 (2026-07-10 · 16종 시안에서 확보)]] *(2026-07-16 옛 3-3에서 이관)*
