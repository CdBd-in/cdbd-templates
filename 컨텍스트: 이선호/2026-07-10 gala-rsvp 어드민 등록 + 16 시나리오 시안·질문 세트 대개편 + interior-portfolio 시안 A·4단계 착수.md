...
related: "[[4-9-2. 16 시나리오 테스트]], [[4-2. AI 유저 플로우]], [[4-5. 섹션 라이브러리]], [[../CLAUDE.md]]"
---
...
프리셋 라이브러리가 아직 비어 있어, **여러 프리셋이 있다는 가정**으로 배리에이션 축을 시안에 심었다. 상세 표: [[4-5. 섹션 라이브러리#🎨 디자인 속성 변주 — 검증된 수단 7가지 (2026-07-10 · 16종 시안에서 확보)]] *(2026-07-16 옛 3-3에서 이관)*
